...
/**
 * Classe que trata das mensagens na aplicação para que as mensagens sejam apresentadas corretamente entre as
 * requests no fluxo da aplicação.
 * @author BRUNO VIANA
 */
public class MessagesListener implements PhaseListener {
	...
	} // fim do método restaurarMensagens
